...
> [!info]
> You may copy the code from this website by clicking the icon on the top-right conner of every code blocks.
```html
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="info block">
	<dl>
		...
		<dt>Brief Introduction</dt>
			<dd>
				Enter a magical kingdom inspired by fairy-tale dreams and explore 7 lands - Adventureland, Grizzly Gulch, Mysitic Point, Toy Story Land, Fantasyland, Tommorowland and Main Street, USA - filled with beauty, excitement and Disney Characters.
			</dd>
		<dt>Location</dt>
			<dd>
...
<body>
    ...
    <ul>
        ...
        <li>
            ...
            .welcome_message (color: blue, font-size:20px),<br>
            ...
        </li>
        <li>
